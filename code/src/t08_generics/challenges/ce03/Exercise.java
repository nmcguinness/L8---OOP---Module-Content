...
//
//        try {
//            codes = org.challenge.FileHelper.readStringsFromCsv(csvPath, false);
//        } catch (Exception e) {
...
//        org.challenge.PrintHelper.printSortedByKey(counts);
//    }
//
...
//
//        List<org.challenge.Weapon> weapons;
//        try {
//            weapons = org.challenge.FileHelper.readWeaponsFromXml(xmlPath);
//        } catch (Exception e) {
//            throw new RuntimeException(e);
//        }
//
//        long start = System.nanoTime();
//        Map<org.challenge.Weapon, Integer> counts = countByKey(weapons);
//        long end = System.nanoTime();
//
